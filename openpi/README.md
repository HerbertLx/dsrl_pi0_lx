...
source /root/storage/CODE/txy/dsrl_pi0_lx/openpi_old/.venv/bin/activate # 服务器环境
export HF_LEROBOT_HOME=/root/storage/CODE/txy/dsrl_pi0_lx/openpi/dataset
export XLA_PYTHON_CLIENT_PREALLOCATE=false
XLA_PYTHON_CLIENT_MEM_FRACTION=0.9 
CUDA_VISIBLE_DEVICES=6,7 /root/storage/CODE/txy/dsrl_pi0_lx/openpi_old/.venv/bin/python scripts/train.py pi0_airbot_local --exp-name=lx_experiment --overwrite
```
...
```bash
uv run scripts/serve_policy.py policy:checkpoint --policy.config=pi0_airbot_local --policy.dir=/root/storage/CODE/txy/dsrl_pi0_lx/openpi/checkpoints/pi0_airbot_local/lx_experiment/99999
```
